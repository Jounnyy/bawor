        ...
        <div className='content__news container'>
          <div className='content__news__left'>
            <div className='title__content__news'>
              <h2>{t('news.news_1.title')}</h2>
            </div>
            <div className='content__image__news'>
              <img src={shanaya} alt='main_content' className='image__news__content' />
            </div>
            <div className='content'>
              <p className='content-1'>
                {t('news.news_1.content_1')}
              </p>
              <p className='content-2'>
                {t('news.news_1.content_2')}
              </p>
              <p className='content-3'>
                {t('news.news_1.content_3')}
              </p>
              <p className='content-4'>
                {t('news.news_1.content_4')}
              </p>
            </div>
          </div>

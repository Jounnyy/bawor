...
import shanaya from '../assets/shanaya films.jpg';
        ...
        <div className='content__news container'>
          <div className='content__news__left'>
            <div className='title__content__news'>
              <h2>{t('news.news_4.title')}</h2>
            </div>
            <div className='content__image__news'>
              <img src={kenny} alt='main_content' className='image__news__content' />
            </div>
            <div className='content'>
              <p className='content-1'>
                {t('news.news_4.content_1')}
              </p>
            </div>
          </div>
          <div className='content__news__right'>
            ...
            <div className='other__news'>
              <a href='/news/shanaya-films' className='other__news__box'>
                <div className='left__other__news'>
                  <img src={shanaya} alt='news' className='image__other__news' />
                </div>
                <div className='right__other__news'>
                  <h2 className='other__news__title'>{t('news.news_1.title')}</h2>
                  <p className='other__news__desc'>{t('news.news_1.short_desc')}</p>
                </div>
              </a>
              ...
              <a href='/news/mata-dewa' className='other__news__box'>
                <div className='left__other__news'>
                  <img src={mataDewa} alt='news' className='image__other__news' />
                </div>
                <div className='right__other__news'>
                  <h2 className='other__news__title'>{t('news.news_2.title')}</h2>
                  <p className='other__news__desc'>{t('news.news_2.short_desc')}</p>
                </div>
              </a>
            </div>
          </div>
